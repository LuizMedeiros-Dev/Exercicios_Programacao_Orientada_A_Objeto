...
//        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates. 
    ...
    private void initComponents() {
        ...
        jTextField1.setBackground(new java.awt.Color(242, 242, 244));
 ...
 if (jTable2.getSelectedRow()!= -1){ //-1 representa que não selecionou a linha da tabela= indice -1 
         ...
         if ((jTable2.getValueAt(jTable2.getSelectedRow(), 5).toString()).equals("M")){ 
         ...
         jTextArea1.setText(jTable2.getValueAt(jTable2.getSelectedRow(), 6).toString()); 
